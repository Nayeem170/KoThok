...
fn screenshot_tap_in_bottom_left_corner_captures() {
    ...
    assert!(is_screenshot_hold(
        70.0, 1410.0, 73.0, 1412.0, 2100, 1072.0, 1448.0
    ));
    assert!(is_screenshot_hold(
        70.0, 1410.0, 70.0, 1410.0, 120, 1072.0, 1448.0
    ));
}
...
fn screenshot_hold_rejected_outside_the_corner() {
    ...
    // sits there at x~515).
    assert!(!is_screenshot_hold(
        536.0, 55.0, 536.0, 55.0, 2100, 1072.0, 1448.0
    ));
    // Bottom-right corner.
    assert!(!is_screenshot_hold(
        1011.0, 1400.0, 1011.0, 1400.0, 2100, 1072.0, 1448.0
    ));
    // Mid-screen.
    assert!(!is_screenshot_hold(
        50.0, 700.0, 50.0, 700.0, 2100, 1072.0, 1448.0
    ));
}
...
fn screenshot_hold_rejected_when_finger_drifts() {
    ...
    assert!(!is_screenshot_hold(
        70.0, 1410.0, 400.0, 1410.0, 2100, 1072.0, 1448.0
    ));
}
