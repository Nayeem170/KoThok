...
Copy it to the Kobo .kobo folder as KoboRoot.tgz, eject, hold power 30s to reboot.
"@
    }
    ...
    Copy-Item -LiteralPath $tgzPath -Destination (Join-Path $koboDir 'KoboRoot.tgz') -Force
